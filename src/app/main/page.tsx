  ...
  return (
    <section className="size-full mt-5 flex gap-10 items-center justify-center text-white">
      ...
      <div className="size-full relative">
        ...
        <Image src={Dice} alt="Dice" className="size-44 absolute top-1/3 left-[45%] animate-bounce-fast" />
        <Image src={Dog} alt="Dog" className="size-48 absolute bottom-[20%] left-[15%] animate-bounce-medium" />
        <Image src={Snake} alt="Snake" className="size-56 absolute bottom-[18%] right-[10%] animate-bounce-slow" />
        <Image src={Warrior} alt="Warrior" className="size-48 absolute top-10 right-[15%] animate-bounce" />
      </div>
    </section>
  );
}
